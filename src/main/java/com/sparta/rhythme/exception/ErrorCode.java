package com.sparta.rhythme.exception;
...
public enum ErrorCode {
    ...
    INVALID_MEMBER_INFO(HttpStatus.BAD_REQUEST.value(),"M008" ,"잘못된 사용자 정보입니다."),
    UNAUTHORIZED(HttpStatus.BAD_REQUEST.value(),"M009" ,"로그인이 필요합니다.");
