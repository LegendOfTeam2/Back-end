...
//    public ResponseEntity<?> pagemakerpost(@RequestParam(required = false, defaultValue = "") String searchText) {
//        return postService.searchmakerposts(searchText);
//    }
    ...
    @GetMapping("/auth/makerpost/search")
